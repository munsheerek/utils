...
/* Source and licensing information for the line(s) below can be found at https://www.elements-show.de/sites/all/themes/elements/js/libs/vendor/jquery.twentytwenty.js. */
(function(t) {
    t.fn.twentytwenty = function(e) {
        ...
        return this.each(function() {
            var a = e.default_offset_pct,
                n = t(this),
                i = e.orientation,
                y = (i === "vertical") ? "down" : "left",
                p = (i === "vertical") ? "up" : "right";
            n.wrap("<div class='twentytwenty-wrapper twentytwenty-" + i + "'></div>");
            n.append("<div class='twentytwenty-overlay'></div>");
            var s = n.find("img:first"),
                v = n.find("img:last");
            n.append("<div class='twentytwenty-handle'></div>");
            var d = n.find(".twentytwenty-handle");
            d.append("<span class='twentytwenty-" + y + "-arrow'></span>");
            d.append("<span class='twentytwenty-" + p + "-arrow'></span>");
            n.addClass("twentytwenty-container");
            s.addClass("twentytwenty-before");
            v.addClass("twentytwenty-after");
            var f = n.find(".twentytwenty-overlay");
            f.append("<div class='twentytwenty-before-label'></div>");
            f.append("<div class='twentytwenty-after-label'></div>");
            var o = function(t) {
                    var e = s.width(),
                        n = s.height();
                    return {
                ...
                l = function(t) {
                    if (i === "vertical") {
                        s.css("clip", "rect(0," + t.w + "," + t.ch + ",0)")
                    } else {
                        s.css("clip", "rect(0," + t.cw + "," + t.h + ",0)")
                    };
                    n.css("height", t.h)
                },
                c = function(t) {
                    var e = o(t);
                    d.css((i === "vertical") ? "top" : "left", (i === "vertical") ? e.ch : e.cw);
                    l(e)
                };
            ...
            var r = 0,
                w = 0;
            d.on("movestart", function(t) {
                if (((t.distX > t.distY && t.distX < -t.distY) || (t.distX < t.distY && t.distX > -t.distY)) && i !== "vertical") {
                    t.preventDefault()
                } else if (((t.distX < t.distY && t.distX < -t.distY) || (t.distX > t.distY && t.distX > -t.distY)) && i === "vertical") {
                    t.preventDefault()
                };
                n.addClass("active");
                r = n.offset().left;
            ...
            d.on("moveend", function(t) {
                n.removeClass("active")
            });
            d.on("move", function(e) {
                if (n.hasClass("active")) {
                    a = (i === "vertical") ? (e.pageY - offsetY) / imgHeight : (e.pageX - r) / w;
                    if (a < 0) {
                        a = 0
                    };
                    if (a > 1) {
                ...
                t(document).trigger("twentytwenty-slider-moved", a)
            });
